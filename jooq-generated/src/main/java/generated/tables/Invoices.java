...
public class Invoices extends TableImpl<InvoicesRecord> {
     ...
     */
    public final TableField<InvoicesRecord, LocalDateTime> DATE = createField(DSL.name("date"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>public.invoices.organisation_id</code>.
     */
    public final TableField<InvoicesRecord, Integer> ORGANISATION_ID = createField(DSL.name("organisation_id"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<ForeignKey<InvoicesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.INVOICES__INVOICES_ORGANISATION_ID_FKEY);
    }

    private transient Organisations _organisations;

    /**
     * Get the implicit join path to the <code>public.organisations</code>
     * table.
     */
    public Organisations organisations() {
        if (_organisations == null)
            _organisations = new Organisations(this, Keys.INVOICES__INVOICES_ORGANISATION_ID_FKEY);
